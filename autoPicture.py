...
takePicture2 = 'adb -s '+camera1+' shell \"input keyevent KEYCODE_CAMERA\"'
...
def pullPicture2():
	os.system('sleep 1')
	os.system('adb -s '+camera2+' shell mv /sdcard/DCIM/Camera/IMG_20190126*.jpg /sdcard/DCIM/Camera/road2.jpg')
	os.system('adb -s '+camera2+' pull /sdcard/DCIM/Camera/road1.jpg C:\\Users\\obiaf\\Documents\\ConUHacks19\\road_pics')
